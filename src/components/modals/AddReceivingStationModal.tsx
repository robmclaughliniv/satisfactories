...
export function AddReceivingStationModal() {
  const { st, up, world } = useStore();
  const { confirmAddReceivingStation } = useActions();
    ...
    >
      ...
      >
        <div style={{ padding: '18px 22px', borderBottom: '1px solid #1C2027', display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{ fontFamily: SG, fontWeight: 600, fontSize: 16, flex: 1 }}>Add receiving station</div>
          ...
          <div style={{ padding: '20px 22px', display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div style={{ fontSize: 11, color: '#6B7280', lineHeight: 1.45 }}>
                Creates a new import station for {m.item} at this factory.
              </div>
            </div>
          </div>
